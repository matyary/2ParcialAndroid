...
class FragmentSelectViewModel : ViewModel() {
    // TODO: Implement the ViewModel
    var sports : MutableList<Sport> = ArrayList<Sport>()
    ...
    fun sportList ()
    {
        ...
        sports.add(Sport("JUMPING JACKS",
            ...
            "AEROBICO"))
        sports.add(Sport("MOUNTAIN CLIMBER",
        ...
        sports.add(Sport("SPRINT",
            ...
            "AEROBICO"))
        sports.add(Sport("FLUTTER KICKS",
            ...
            "AEROBICO"))
        sports.add(Sport("FLEXIONES DE BRAZOS",
        ...
        sports.add(Sport("SENTADILLAS",
            ...
            "MUSCULACION"))
        sports.add(Sport("SENTADILLAS PLIOMETRICAS",
            ...
            "MUSCULACION"))
        sports.add(Sport("STEP O SUBIDA DE ESCALON",
            ...
            "MUSCULACION"))
        sports.add(Sport("ELEVACION DE PELVIS",
        ...
        sports.add(Sport("DOMINADAS",
            ...
            "MUSCULACION"))
        sports.add(Sport("ABDOMINALES CLÁSICOS",
            ...
            "MUSCULACION"))
        sports.add(Sport("TORSION DE ESPALDA",
        ...
        sports.add(Sport("ABDUCTORES",
            ...
            "FLEXIBILIDAD"))
        sports.add(Sport("ZANCADA EN SOFA",
